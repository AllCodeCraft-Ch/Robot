...
void loop() {
  ...
  moveForward();
  delay(800);  // ปรับระยะเวลาเพื่อให้ได้ 5 ซม.
  stopMotor();
  ...
  // เลี้ยวซ้าย 90 องศา
  turnLeft();
  delay(950);  // ปรับระยะเวลาเพื่อให้ได้การเลี้ยว 90 องศา
  stopMotor();
  ...
  moveForward();
  delay(6000);  // ปรับระยะเวลาเพื่อให้ได้ 4 เมตร
  stopMotor();
...
void turnLeft() {
  ...
  analogWrite(ENB, 250); // มอเตอร์ด้านขวาหมุนเดินหน้า
}
