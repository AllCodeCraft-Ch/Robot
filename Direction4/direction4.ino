...
void loop() {
   // เลี้ยวซ้าย 90 องศา
  turnRigh();
  delay(730);  // ปรับระยะเวลาเพื่อให้ได้การเลี้ยว 90 องศา
  stopMotor();
  ...
  moveForward();
  delay(1000);  // ปรับระยะเวลาเพื่อให้ได้ 5 ซม.
  stopMotor();
  ...
  turnLeft();
  delay(850);  // ปรับระยะเวลาเพื่อให้ได้การเลี้ยว 90 องศา
  stopMotor();
  ...
  moveForward();
  delay(4000);  // ปรับระยะเวลาเพื่อให้ได้ 2 เมตร
  stopMotor();
  ...
  turnLeft();
  delay(1050);  // ปรับระยะเวลาเพื่อให้ได้การเลี้ยว 90 องศา
  stopMotor();
  ...
  moveForward();
  delay(8000);  // ปรับระยะเวลาเพื่อให้ได้ 2 เมตร
  stopMotor();
